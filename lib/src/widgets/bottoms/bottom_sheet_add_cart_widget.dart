            ...
            child: Column(
              children: [
                Row(
                  children: [
                    ImageWidget(
                      imageUrl: _productEditor.imagesUrl?.firstOrNull,
                      width: 80,
                      height: 80,
            ...
            onPressed:
                _qtyTextController.text.isEmpty ||
                    ...
                    : () async {
                      ...
                      final productFromDb = await productRepository.getById(appCubit.request(_productEditor.id));

                      log('productFromDb ${productFromDb.response}');
