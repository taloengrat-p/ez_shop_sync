...
class TransactionsChartDetailsPage extends StatefulWidget {
  const TransactionsChartDetailsPage({super.key});
...
class _TransactionsChartDetailsState extends State<TransactionsChartDetailsPage> {
  final _cubit = GetIt.I<TransactionsChartDetailsCubit>();
  ...
  Widget build(BuildContext context) {
    return BlocListener<TransactionsChartDetailsCubit, TransactionsChartDetailsState>(
      bloc: _cubit,
            ...
            children: [
              ...
              Container(
                ...
                child: Column(
                  ...
                  children: [
                    Text(LocaleKeys.category.tr(), style: Theme.of(context).textTheme.titleMedium?.copyWith()),
                    if (_cubit.appCubit.categories.isEmpty)
                      SizedBox(height: 200, child: Center(child: Text(LocaleKeys.categoryEmpty.tr()))),
                    if (_cubit.appCubit.categories.isNotEmpty) ..._cubit.appCubit.categories.map((e) => Text(e.name)),
                  ],
                ),
              ),
              Container(color: Colors.white, width: double.infinity, height: DimensionsKeys.heightBts * 2),
            ],
          ),
