...
class _CreateProductDetailState extends State<CreateProductDetailPage> {
  late CreateProductDetailCubit _cubit;
  @override
  void initState() {
    super.initState();
    _cubit = CreateProductDetailCubit();
  ...
  Widget build(BuildContext context) {
    return BlocProvider(
      ...
      child: BlocListener<CreateProductDetailCubit, CreateProductDetailState>(
            ...
            return BaseScaffolds(
              ...
              bottomNavigationBar: Container(
                ...
                child: ButtonWidget(
                  ...
                  onPressed: () {
                    CreateProductDetailRouter(context).pop(ProductType(
